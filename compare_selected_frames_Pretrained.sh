...
HRNET_MODEL="output_pretrained/mpi_inf_3dhp/pose_hrnet/w48_384x288_adam_lr1e-3_mpi_inf_3dhp/model_best.pth"

python3 tools/compare_gt_hrnet_selected_frames.py \
    --cfg "${HRNET_CFG}" \
    --sequence "TS1" \
    --frames 600 1200 1800 2400 3000 3600 4200 4800 5400 6000 \
    --model-path "${HRNET_MODEL}" \
    --output-dir "comparison_selected_frames_pretrained" \
    --img-size "640" \
    --batch-size "32" \
    --device "cuda:0"
