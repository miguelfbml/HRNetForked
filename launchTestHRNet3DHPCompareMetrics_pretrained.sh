...
#SBATCH --job-name=HRNet3DHP_Test_CompareMetrics_pretrained
...
MODEL_FILE="output_pretrained/mpi_inf_3dhp/pose_hrnet/w48_384x288_adam_lr1e-3_mpi_inf_3dhp/model_best.pth"
