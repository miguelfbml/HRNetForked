...
#SBATCH --job-name=HRNet3DHP_Train_CompareMetrics
#SBATCH --output=slurm_%x.%j.out
#SBATCH --error=slurm_%x.%j.err

echo "Starting HRNet MPI-INF-3DHP train-set compare video + metrics (MPJPE/PCK/AUC)"
