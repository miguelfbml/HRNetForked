...
def parse_args():
    parser = argparse.ArgumentParser(description='YOLO11l-pose FPS benchmark on COCO val images')
    parser.add_argument(
        '--model-file',
        type=str,
        default='yolo11l-pose.pt',
        help='Path to YOLO11l-pose model weights',
    )
    parser.add_argument(
        '--image-dir',
        type=str,
...
def main():
    ...
    print('YOLO11l-pose FPS benchmark complete')
